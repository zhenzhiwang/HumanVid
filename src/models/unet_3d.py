...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            #print(f"upsample_block: {i}, is_final_block: {is_final_block}")
            ...
            print(f'upsample_block={i}, upsample_size={upsample_size}, res_samples={len(res_samples)}, down_block_res_samples= {len(down_block_res_samples)}')
