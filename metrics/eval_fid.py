...
from utils.fid_inception import InceptionV3
...
IMAGE_EXTENSIONS = {"bmp", "jpg", "jpeg", "pgm", "png", "ppm", "tif", "tiff", "webp", "mp4"}
...
def calculate_fid_given_paths(paths, batch_size, device, dims, num_workers=1):
    ...
    #print(f"m1={m1}, s1={s1}", f"m2={m2}, s2={s2}")
...
def main():
    ...
    res_video_root_paths = [#'/mnt/afs/wangzhenzhi/code/animate-with-camera/output/stage2-sense-evaluation-all/frame_pexels-test-h_20240709_1250--seed_42-512x896',
    ...
    gt_video_root_paths = [#'/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-h/frames',
                           # '/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-v/frames',
                           # '/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-h/frames',
                           # '/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-v/frames',
                            '/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-h/frames',
                            '/mnt/afs/wangzhenzhi/code/animate-with-camera/data/pexels-test-v/frames']"""
    dataset_names = ['tiktok_ue-1st-stage']  # 'all_pexels-h', 'all_pexels-v', 'real_pexels-h', 'real_pexels-v',
    res_video_root_paths = ['/mnt/afs/wangzhenzhi/code/animate-with-camera/output/stage2-sense-evaluation-tiktok-dpvo-real/frames_20240816_2041--seed_42-512x896']
    gt_video_root_paths = ['/mnt/afs/wangzhenzhi/code/animate-with-camera/data/tiktok/test/frames']

    """dataset_names = ['ubc']  # 'all_pexels-h', 'all_pexels-v', 'real_pexels-h', 'real_pexels-v', 
    res_video_root_paths = ['/mnt/afs/wangzhenzhi/code/animate-with-camera/output/stage2-sense-evaluation-ubc/frames_test_20240813_1919--seed_42-512x672']
    gt_video_root_paths = ['/mnt/afs/wangzhenzhi/code/animate-with-camera/data/ubc/test/frames']"""
    ...
    for dataset_name, res_video_root_path, gt_video_root_path in zip(dataset_names, res_video_root_paths, gt_video_root_paths):
        ...
        save_dir = Path("output/fid/")
        save_dir.mkdir(parents=True, exist_ok=True)
        result_dict = {"FID": fid_value}
        with open(os.path.join(save_dir, f"{date_str}-{time_str}_{dataset_name}_fid_results.json"), 'w') as fp:
